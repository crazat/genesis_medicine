"""5000 conformer × R4 expanded 194 mol."""
import sys, time
...
def main():
    ...
    pd.DataFrame(valid).to_csv(OUT / "conformers_5000_r4_full194.csv", index=False)
    print(f"✅ conformers_5000_r4_full194.csv ({len(valid)})")

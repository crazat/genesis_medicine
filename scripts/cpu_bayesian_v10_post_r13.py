"""Bayesian v10 — R7-R12 통합 → R14 candidates."""
...
def main():
    ...
    out = OUT / "bayesian_v10_round14_candidates.csv"
    ...
    print(f"\n** Bayesian saturate trace — EI top {pool_v['expected_improvement'].iloc[0]:.4f} (R10:0.0069 → R11:0.0123 → R12:0.0077 → R14:?) **")
    return 0

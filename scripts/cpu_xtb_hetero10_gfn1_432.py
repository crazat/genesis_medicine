"""xtb GFN1 672-conf refine on hetero10 top9997 cohort.

Extends paper #A §3.6 conformer ladder from 4-point (432/480/528/576) to 5-point.
Source: 432-conf csv (986 mol). Resumable on np_id.
22 subprocess workers (safe alongside OpenMM CUDA).
"""
...
OUT = ROOT / "pilot/cpu_meaningful/xtb_npass_top9997_hetero10_gfn1_432conf.csv"
NUM_CONFS = 432
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            for cid in cids:
                ...
                proc = subprocess.run(
                    [str(XTB_BIN), str(xyz), "--gfn", "1", "--alpb", "water"],

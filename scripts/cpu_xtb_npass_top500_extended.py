"""xtb GFN2 on NPASS top 500 (extended saturation while MD runs)."""
...
def main():
    ...
    top = npass.nlargest(500, "log_kp_pottsguy").reset_index(drop=True)
    print(f"NPASS top 500 by Potts-Guy logKp")

    import tempfile
    with tempfile.TemporaryDirectory(prefix="xtb_npass500_") as tmpdir:
    ...
    out_csv = OUT / "xtb_npass_top500.csv"

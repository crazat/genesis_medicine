"""R16 topical chromanol dimethyl pigment-target 30 ns MD.

Completes the R16 topical chromanol 18-pair matrix by extending the remaining
dimethyl TYR/DCT cofold pairs to 30 ns. TGFB1 dimethyl pairs are already
covered by the TGFB1 extra 30 ns run.

Output:
  pilot/md_r16_chromanol_topical_dimethyl_pigment_30ns/summary.json
  pilot/md_r16_chromanol_topical_dimethyl_pigment_30ns/summary.csv
"""
...
OUT = ROOT / "pilot/md_r16_chromanol_topical_dimethyl_pigment_30ns"
...
def build_jobs(runner) -> list[dict[str, object]]:
    ...
    rows = df[
        ...
        & df["analog_id"].astype(str).str.contains("Me", regex=False)
...
def main() -> int:
    ...
    print("R16 topical chromanol dimethyl pigment-target 30 ns MD")
    if jobs:
        print(
            pd.DataFrame(jobs)[
    ...
    print("\nFinal R16 topical chromanol dimethyl pigment 30 ns summary:")

"""R11_0 super-leader × 추가 5 target MD ensemble (paper-tier 10/14 완성).

Already done: TGFB1+MITF+SREBP1+MMP1+SRD5A1 (5/5 paper-tier 0.71-1.54 Å).
This run: CTGF+AR+LOX+SIRT1+TYR — completes R11_0 universal scaffold validation.

Sequential 10 ns × 5 = ~45 min GPU. Output: pilot/md_r11_0_extra5
"""
...
OUT = ROOT / "pilot/md_r11_0_extra5"
OUT.mkdir(parents=True, exist_ok=True)

R11_0_SMI = "OCc1ccc(C=CC2COc3cc(O)ccc3C2)c(O)c1O"

JOBS = [
    {"name": "ctgf__r11_0",   "cif": "pilot/cpu_meaningful/output_r11_ctgf/boltz_results_inputs_r11_ctgf/predictions/r11_ctgf_0/r11_ctgf_0_model_0.cif"},
    {"name": "ar__r11_0",     "cif": "pilot/cpu_meaningful/output_r11_ar/boltz_results_inputs_r11_ar/predictions/r11_ar_0/r11_ar_0_model_0.cif"},
    {"name": "lox__r11_0",    "cif": "pilot/cpu_meaningful/output_r11_lox/boltz_results_inputs_r11_lox/predictions/r11_lox_0/r11_lox_0_model_0.cif"},
    {"name": "sirt1__r11_0",  "cif": "pilot/cpu_meaningful/output_r11_sirt1/boltz_results_inputs_r11_sirt1/predictions/r11_sirt1_0/r11_sirt1_0_model_0.cif"},
    {"name": "tyr__r11_0",    "cif": "pilot/cpu_meaningful/output_r11_tyr/boltz_results_inputs_r11_tyr/predictions/r11_tyr_0/r11_tyr_0_model_0.cif"},
]
...
def main():
    print("=" * 72)
    print("R11_0 × 추가 5 target MD ensemble (CTGF/AR/LOX/SIRT1/TYR)")
    ...
    print("\n" + "=" * 70)
    print("R11_0 extra-5 MD ensemble — final summary")
    print("=" * 70)

"""R11_0 super-leader (10/14 multi-target top-5) × 5 best targets MD ensemble.

R11_0 SMILES: pterocarpan-vinyl-pyrogallol scaffold
  OCc1ccc(C=CC2COc3cc(O)ccc3C2)c(O)c1O

Top 5 targets by R11 affinity:
  1. TGFB1  0.777 (scar — primary)
  2. MITF   0.744 (pigment)
  3. SREBP1 0.742 (acne)
  4. MMP1   0.740 (scar)
  5. SRD5A1 0.704 (alopecia/acne)

Sequential 10 ns × 5 = ~2.5h GPU. Replaces ABFE 12h (template-only impl).
Paper-tier RMSD validation for top NEW R11 super-leader.
"""
...
OUT = ROOT / "pilot/md_r11_0_multitarget"
OUT.mkdir(parents=True, exist_ok=True)

R11_0_SMI = "OCc1ccc(C=CC2COc3cc(O)ccc3C2)c(O)c1O"

JOBS = [
    {"name": "tgfb1__r11_0",  "cif": "pilot/cpu_meaningful/output_r11_tgfb1/boltz_results_inputs_r11_tgfb1/predictions/r11_tgfb1_0/r11_tgfb1_0_model_0.cif"},
    {"name": "mitf__r11_0",   "cif": "pilot/cpu_meaningful/output_r11_mitf/boltz_results_inputs_r11_mitf/predictions/r11_mitf_0/r11_mitf_0_model_0.cif"},
    {"name": "srebp1__r11_0", "cif": "pilot/cpu_meaningful/output_r11_srebp1/boltz_results_inputs_r11_srebp1/predictions/r11_srebp1_0/r11_srebp1_0_model_0.cif"},
    {"name": "mmp1__r11_0",   "cif": "pilot/cpu_meaningful/output_r11_mmp1/boltz_results_inputs_r11_mmp1/predictions/r11_mmp1_0/r11_mmp1_0_model_0.cif"},
    {"name": "srd5a1__r11_0", "cif": "pilot/cpu_meaningful/output_r11_srd5a1/boltz_results_inputs_r11_srd5a1/predictions/r11_srd5a1_0/r11_srd5a1_0_model_0.cif"},
]
...
def main():
    print("=" * 72)
    print("R11_0 super-leader × 5 multi-targets MD ensemble (10 ns × 5 = ~2.5h GPU)")
    print(f"SMILES: {R11_0_SMI}")
    print("=" * 72)

    results = []
    for job in JOBS:
        r = run_md(job["name"], job["cif"], R11_0_SMI, ns=10.0)
        results.append(r)
    ...
    print("\n" + "=" * 70)
    print("R11_0 multi-target MD ensemble — final summary")
    print("=" * 70)

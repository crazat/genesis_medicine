"""Consolidate R11 affinity results (14 target × 30 candidates)."""
...
def main():
    candidates = pd.read_csv(OUT / "bayesian_v7_round11_candidates.csv").head(30)
    rows = []
    for tgt in TARGETS:
        pred_dir = OUT / f"output_r11_{tgt}/boltz_results_inputs_r11_{tgt}/predictions"
    ...
    out_csv = OUT / "r11_affinity_consolidated.csv"

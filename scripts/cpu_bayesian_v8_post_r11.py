"""Bayesian v8 — R7-R11 통합 (~3600+ cofold) → R12 candidates."""
...
def main():
    ...
    out = OUT / "bayesian_v8_round12_candidates.csv"
    ...
    print(f"\n** Bayesian saturate 확인 — EI top {pool_v['expected_improvement'].iloc[0]:.4f} (R10:0.0069 → R11:0.0123 → R12:?) **")
    return 0

"""R17 expanded green-target 60 ns MD follow-up.

This extends the three non-duplicate safety-green DCT/TYR candidates that
completed run_r17_chromanol_generative_expanded_green_30ns.py.

Output:
  pilot/md_r17_chromanol_generative_expanded_green_60ns/summary.json
  pilot/md_r17_chromanol_generative_expanded_green_60ns/summary.csv
"""
...
PREV = ROOT / "pilot/md_r17_chromanol_generative_expanded_green_30ns/summary.json"
OUT = ROOT / "pilot/md_r17_chromanol_generative_expanded_green_60ns"
...
def main() -> int:
    ...
    print("R17 expanded green-target 60 ns MD")
    if not jobs:
        print("No completed expanded-green 30 ns jobs found.")
        return 0
    print(
        pd.DataFrame(jobs)[
            [
    ...
    print("\nFinal R17 expanded green-target 60 ns summary:")

"""R17 generative chromanol next green-target 30 ns MD follow-up.

This extends the three non-duplicate DCT/TYR candidates that completed
run_r17_chromanol_generative_next_green_10ns.py. Aryl-halogen rows remain
...
Output:
  ...
  pilot/md_r17_chromanol_generative_next_green_30ns/summary.csv
"""
...
PREV = ROOT / "pilot/md_r17_chromanol_generative_next_green_10ns/summary.json"
OUT = ROOT / "pilot/md_r17_chromanol_generative_next_green_30ns"
...
def main() -> int:
    ...
    print("R17 generative chromanol next green-target 30 ns MD")
    if not jobs:
        print("No completed next-green 10 ns jobs found.")
        return 0
    print(
        pd.DataFrame(jobs)[
            [
    ...
    print("\nFinal R17 generative chromanol next green-target 30 ns summary:")

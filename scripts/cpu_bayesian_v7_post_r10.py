"""Bayesian v7 — R1-R10 통합 (~3000+ cofold) → R11 candidates check."""
...
def main():
    ...
    out = OUT / "bayesian_v7_round11_candidates.csv"
    ...
    print(f"\n** Bayesian saturate 확인 — EI top {pool_v['expected_improvement'].iloc[0]:.4f} (이전 R10: 0.0069) **")
    return 0

"""Bayesian v6 — R1-R9 통합 → R10 candidates."""
...
def main():
    print("=" * 72)
    print("Bayesian v6 — R1-R9 통합 (R10 candidates)")
    print("=" * 72)

    pieces = []
    pre_r5 = OUT / "all_boltz2_affinity_consolidated_r5.csv"
    if pre_r5.exists(): pieces.append(pd.read_csv(pre_r5))
    for r in [7, 8, 9]:
    ...
    out = OUT / "bayesian_v6_round10_candidates.csv"

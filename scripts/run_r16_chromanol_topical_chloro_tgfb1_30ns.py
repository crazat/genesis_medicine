"""R16 topical chromanol chlorinated TGFB1 positional-isomer 30 ns MD.

Runs the TGFB1 chlorinated R16 analogs that were not covered by the priority
30 ns lead validation. This is a robustness check for the chloro positional
series, not a replacement for the current R15_chromanol_Cl_pos9 lead call.

Output:
  pilot/md_r16_chromanol_topical_chloro_tgfb1_30ns/summary.json
  pilot/md_r16_chromanol_topical_chloro_tgfb1_30ns/summary.csv
"""
...
OUT = ROOT / "pilot/md_r16_chromanol_topical_chloro_tgfb1_30ns"
...
def main() -> int:
    ...
    print("R16 topical chromanol chloro TGFB1 positional-isomer 30 ns MD")
    if jobs:
        print(
            pd.DataFrame(jobs)[
    ...
    print("\nFinal R16 topical chromanol chloro TGFB1 30 ns summary:")

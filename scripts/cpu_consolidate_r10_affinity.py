"""Consolidate R10 affinity results."""
...
def main():
    candidates = pd.read_csv(OUT / "bayesian_v6_round10_candidates.csv").head(30)
    rows = []
    for tgt in TARGETS:
        pred_dir = OUT / f"output_r10_{tgt}/boltz_results_inputs_r10_{tgt}/predictions"
    ...
    out_csv = OUT / "r10_affinity_consolidated.csv"

"""Consolidate R14 affinity results (14 target × 30 candidates)."""
...
def main():
    ...
    rows = []
    for tgt in TARGETS:
        pred_dir = OUT / f"output_r14_{tgt}/boltz_results_inputs_r14_{tgt}/predictions"
    ...
    out_csv = OUT / "r14_affinity_consolidated.csv"

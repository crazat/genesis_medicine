"""R16 topical chromanol TGFB1 top-6 60 ns MD.

Runs a longer TGFB1-focused robustness panel across the six R16 topical
analogs after the full 18-pair 30 ns matrix is complete.

Output:
  pilot/md_r16_chromanol_topical_tgfb1_top6_60ns/summary.json
  pilot/md_r16_chromanol_topical_tgfb1_top6_60ns/summary.csv
"""
...
OUT = ROOT / "pilot/md_r16_chromanol_topical_tgfb1_top6_60ns"
...
def main() -> int:
    ...
    print("R16 topical chromanol TGFB1 top-6 60 ns MD")
    print(
        pd.DataFrame(jobs)[
    ...
    print("\nFinal R16 topical chromanol TGFB1 top-6 60 ns summary:")

"""Consolidate R12 affinity results (14 target × 30 candidates)."""
...
def main():
    candidates = pd.read_csv(OUT / "bayesian_v8_round12_candidates.csv").head(30)
    rows = []
    for tgt in TARGETS:
        pred_dir = OUT / f"output_r12_{tgt}/boltz_results_inputs_r12_{tgt}/predictions"
    ...
    out_csv = OUT / "r12_affinity_consolidated.csv"

...
$\langle\dGbind\rangle$, and deviation from experiment for the seven
compounds.
...
$|\langle\dGbind\rangle - \dGexp|$ for the six compounds with $\geq 2$
replicates: there is no monotonic relationship between the two.

...
_MODELS = [
    ...
    Component("openfold3_weights_p2", ComponentKind.MODEL, "Apache-2.0",
              LicenseTag.COMMERCIAL_SAFE,
              "https://portal.openfold.omsf.io/datasets",
              note="of3-p2-155k.pt — preview-2 checkpoint, redistributable Apache-2.0."),
    Component("aqaffinity", ComponentKind.MODEL, "Apache-2.0",
              LicenseTag.COMMERCIAL_SAFE,
              "https://huggingface.co/SandboxAQ/AQAffinity",
              note="SandboxAQ structure-free affinity head on OpenFold3. HF requires one-time contact-info acknowledgement."),
    Component("aqaffinity_weights", ComponentKind.MODEL, "Apache-2.0",
              LicenseTag.COMMERCIAL_SAFE,
              "https://huggingface.co/SandboxAQ/AQAffinity",
              note="Binding head ckpt. Same Apache-2.0 license as the code."),
